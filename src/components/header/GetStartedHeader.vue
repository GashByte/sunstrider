...
const switchActive = ref(document.querySelector('html')?.getAttribute('data-theme') === 'Light' ? false : true);
...
const switchChangeHandle = async(value:boolean) => {
    ...
    color.value = document.querySelector('html')?.getAttribute('data-theme') === 'Light' ? '#000000' : '#FFFFFF';
    await database.updateData({ id: DatabaseValueEnum.persSunstriderColorMode, value: v });
}
</script>
        ...
        <div class="left-container">
            ...
            <div class="options-group">
                <a href="#why-choose-us" @click="anchorClickEvent">
                    <n-button quaternary :color="color">
                        Why choose us
                    </n-button>
                </a>
